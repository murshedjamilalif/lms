                    ...
                    <div className='card'>
                        ...
                        <div className='card-body'>
                            ...
                            <div className="mb-3 row">
                                ...
                                <div className="col--10">
                                    <input type="file" id="courseVideo" onChange={handleFileChange} name='courseVideo' className="form-control"  />
                                </div>
                            </div>
                            <div className="mb-3 row">
                                <label htmlFor="technologies" className="col-sm-2 col-form-label">Remarks</label>
                                <div className="col--10">
                                    <textarea className='form-control' onChange={handleChange} name='remarls' placeholder='This video is focused on basic introduction' rows="4"></textarea>
                                </div>
                            </div>
                            <div className="mb-3 row">
