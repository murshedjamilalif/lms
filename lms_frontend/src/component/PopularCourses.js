...
function PopularCourses(){
    return(
        ...
        <div className="row">
            ...
            <div className="col-md-3 mb-4">
            <div className="card">
            <Link to="/detail/2"><img src="python.png" className="card-img-top" alt="..."/></Link>
                <div className="card-body">
            ...
            <div className="col-md-3 mb-4">
            <div className="card">
            <Link to="/detail/3"><img src="python.png" className="card-img-top" alt="..."/></Link>
                <div className="card-body">
            ...
            <div className="col-md-3 mb-4">
            <div className="card">
            <Link to="/detail/4"><img src="python.png" className="card-img-top" alt="..."/></Link>
                <div className="card-body">
